...
class Sed_core_user extends MY_Model {
    ...
    public static function add_user($name, $user_name, $password, $type, $recovery_email, $recovery_phone, $created_by) {
        $CI = & get_instance();
    ...
    public function reset_password_by_email($user_id, $recovery_mail, $code) {
        ...
        if ($res != FALSE) {
            ...
            if ($this->common->easy_mail($recovery_mail, 'Eyewear eCommece System - Password Reset', $email_info, $email_content)) {
