<div class="navbar">
    <div class="navbar-inner">
        ...
        <div class="logo-box">
            <a href="<?= base_url('admin/') ?>" class="logo-text"><span><img src="<?= base_url('public/images/logo.jpg'); ?>" width="90px" class="img-responsive"/></span></a>
        </div><!-- Logo Box -->
        ...
        <div class="topmenu-outer">
            <div class="top-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                            <span class="user-name"><?php echo $_SESSION['admin']['name']; ?><i class="fa fa-angle-down"></i></span>
                            <img class="img-circle avatar" src="<?= base_url('public/') ?>images/admin_images/avatar1.png" width="40" height="40" alt="">
                        </a>
                        <ul class="dropdown-menu dropdown-list" role="menu">
                            <li role="presentation"><a href="<?= base_url('admin/brands') ?>"><i class="fa fa-user"></i>Profile</a></li>
