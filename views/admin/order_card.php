...
<html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <!--<![endif]-->
        <title>Eyewear - Order Card</title>
        ...
        <script src="<?php echo base_url('public/js/html2pdf.bundle.min.js'); ?>"></script>
        ...
        <body class="clean-body">
            ...
            <a href="#" title="Click to print this page" class="btn btn-default btn-xs" onclick="window.print()">
            ...
            <a href="#" title="Click to print this page" class="btn btn-default btn-xs pdf-btn" onclick="pdfPrint()">
                <div class="print-btn example-print hvr-bob">
                    <span class="print-icon">
                        <i class="fa fa-print" aria-hidden="true"></i> 
                    </span>
                    &nbsp; <span class="print-hide">Save as PDF</span>
                </div>
            </a>

            <div class="pdf-area" id="element-to-print">
                                ...
                                <div style="background-color: transparent; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;">
                                    ...
                                    <div align="center" style="Margin-right: 0px;Margin-left: 0px;">
                                        <a href="#" target="_blank">
                                            ...
                                            <img class="center fullwidth" align="center" border="0" src="<?= base_url('public/images/logo_gg.png') ?>" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: none;height: auto;float: left;width: auto;max-width: 200px;" >


                                        </a>
                                    </div>
                                    <div style="line-height: 15px; font-size: 1px" class="">&nbsp;</div>
                                </div>
                                <div style="background-color: transparent; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;">
                                    <div style="font-size:1px" class="company-info-div">&nbsp;</div>
                                    <div style="Margin-right: 0px; Margin-left: 0px;" >
                                        ...
                                        <div class="hotel-detail-wrap" style="color:#888888;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                            <p style="margin: 0;font-size: 16px;">
                                                <span style="line-height: 21px;margin-top: 5px;">
                                    ...
                                    <div style="Margin-right: 0px; Margin-left: 0px;">
                                        ...
                                        <div class="hotel-detail-wrap" style="color:#888888;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 17px">
                                                <span style="font-size: 24px; line-height: 28px;"><strong><span style="font-family: 'Verdana', Geneva, sans-serif; line-height: 28px; font-size: 26px;color: #ffffff;float: right;border: 1px solid;padding: 8px 35px;background: black;">ORDER</span>
                                                    </strong>
                                                </span>
                                            </p>
                                            <div style="line-height: 60px;font-size: 1px">&nbsp;</div>
                                            <p style="margin: 0;font-size: 13px;text-align: right;">
                                                Order Number : <?= $order_details['order_number'] ?>
                                            </p>
                                            <p style="margin: 0;font-size: 13px; font-weight: normal !important;text-align: right;">                                       
                                ...
                                <div style="color: white;margin-top: 10px;border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;">
                                    ...
                                    <div style="Margin-right: 15px;">
                                        ...
                                        <div style="font-size:14px;line-height:17px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 17px">
                                                <span style="font-size: 24px; line-height: 28px;"><strong><span style="font-family: 'Verdana', Geneva, sans-serif; line-height: 28px; font-size: 16px;">CUSTOMER DETAILS</span>
                                                    </strong>
                                                </span>
                                            </p>
                            ...
                            <div rel="col-num-container-box" class="col num10" style="">
                                <div style="color: white;margin-top: 10px;border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;">
                                    ...
                                    <div style="Margin-right: 15px; Margin-left: 10px;">
                                        ...
                                        <div style="font-size:14px;line-height:17px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                            <p style="margin: 0;font-size: 14px;line-height: 17px">
                                                <span style="font-size: 24px; line-height: 28px;"><strong><span style="font-family: 'Verdana', Geneva, sans-serif; line-height: 28px; font-size: 16px;">SHIPPING DETAILS</span>
                                                    </strong>
                                                </span>
                                            </p>
                                        </div>
                                    ...
                                    <div style="Margin-right: 15px; Margin-left: 10px;">
                                        ...
                                        <div style="color:#777777;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                            <p style="margin: 0;">
                                                <span style="font-size: 11px; font-family: 'Verdana', Geneva, sans-serif;    line-height: 16px;"><?= $order_details['shipping']['address'] . ',<br> ' . $order_details['shipping']['city'] . ' .<br>' . $order_details['shipping']['country'] ?>.</span>
                                            </p>
                                        </div>
                                    </div>
                ...
                <div style="background-color:transparent;">
                    <div rel="col-num-container-box" style="Margin: 0 auto;min-width: 320px;max-width: 800px;width: 800px;width: calc(19000% - 98300px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;" class="block-grid ">
                        <div style="border-collapse: collapse;display: table;width: 100%;">
                            <div rel="col-num-container-box" class="col num12" style="min-width: 320px;width: 320px;width: calc(18000% - 89500px);background-color: transparent;" id="order-details-div">
                                <div style="font-size:14px;line-height:17px;color:#555555;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;">
                                    <p style="margin: 0;font-size: 14px;line-height: 17px">
                                        <span style="font-size: 24px; line-height: 28px;"><strong><span style="font-family: 'Verdana', Geneva, sans-serif; line-height: 28px; font-size: 16px;">ORDER DETAILS</span>
                                            </strong>
                                        </span>
                                    </p>
                                ...
                                <div style="margin-top: 10px;">
                                    ...
                                    <table class="table table-responsive" style="margin-bottom:0;">
                                        <thead style="border-bottom:1px solid">
                                            <tr>
                                                <th class="booking-table-first-head" style="margin-bottom: 8px;text-align:left;font-size: 14px;font-family: 'Verdana', Geneva, sans-serif;">Item</th>
                                                <th style="text-align:right;font-size: 13px;    width: 150px;font-family: 'Verdana', Geneva, sans-serif;">Unit Price</th>
                                                <th style="text-align:center;font-size: 13px;    width: 150px;font-family: 'Verdana', Geneva, sans-serif;">QTY</th>
                                                <th style="text-align:right;font-size: 14px;    width: 150px;font-family: 'Verdana', Geneva, sans-serif;">Amount</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            foreach ($order_details['items'] as $item) {
                                                $days = '';
                                                $item_price = $item['each_price'] * $item['qty'];
                                                ?>
                                                <tr><td style="margin-bottom: 8px;"><?= $item['item_data']['name'] ?></td><td style="margin-bottom: 8px;text-align: right;"><?= DEFAULT_CURRENCY . ' ' . number_format($item['each_price'], 2) ?></td><td style="margin-bottom: 8px;text-align: center;"><?= $item['qty'] ?></td><td style="margin-bottom: 8px;text-align: right;"> <?= DEFAULT_CURRENCY . ' ' . number_format($item_price, 2) ?></td></tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><strong><?= DEFAULT_CURRENCY . ' ' . number_format($item_total_price, 2); ?></strong></td>
                                            </tr>
                                            <?php
                                            if (!empty($order_details['taxes'])) {
                                                foreach ($order_details['taxes'] as $tax) {
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td></td>
                                                        <td class="text-right"><?= $tax['tax_name'] . ' (' . $tax['percentage'] . '%)'; ?></td>
                                                        <td class="text-right"><?= number_format($tax['tax_amount'], 2); ?></td>
                                                    </tr>
                                                    <?php
                                                    $item_total_price += $tax['tax_amount'];
                                                }
                                            }
                                            ?>
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                <td class="text-right" style="font-weight:bold;">GROSS TOTAL</td>
                                                <td class="text-right" style="font-weight:bold;"><?= DEFAULT_CURRENCY . ' ' . number_format($item_total_price, 2); ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <script>
                function pdfPrint() {
                    ...
                    var opt = {
                        margin: 1,
                        filename: 'Order Card -(<?= $order_details['order_number'] ?>).pdf',
                    };
