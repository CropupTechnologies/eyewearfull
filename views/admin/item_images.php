            ...
            <div class="col-md-12">
                <div class="panel panel-white">
                    <div class="panel-body">
                        ...
                        <form id="frm-save-images" method="post" action="<?= base_url('item/update_item_images') ?>">
                                                ...
                                                foreach ($images as $img) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <img class="item-image-preview" src="<?= base_url('public/runningimages/item/image') . '/' . $img['image_name'] ?>"
                                                        </td>
                                                        <td>
                                            ...
                                            if (file.accepted == true) {
                                                ...
                                                $('<tr>')
                                                        .append($('<td>')
                                                                ...
                                                                .append($('<img>', {'src': BASEURL + 'public/runningimages/item/image/' + upload.hq_image_name}).addClass('item-image-preview'))
                                                                )
