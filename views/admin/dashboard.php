...
<div class="page-inner">
    ...
    <div id="main-wrapper">
                        ...
                        <div class="inbox-widget slimscroll">
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="<?= base_url('public/') ?>images/admin_images/avatar2.png" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="<?= base_url('public/') ?>images/admin_images/avatar3.png" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="<?= base_url('public/') ?>images/admin_images/avatar4.png" class="img-circle" alt=""></div>
                            ...
                            <a href="#">
                                <div class="inbox-item">
                                    <div class="inbox-item-img"><img src="<?= base_url('public/') ?>images/admin_images/avatar5.png" class="img-circle" alt=""></div>
        ...
        <script src="<?= base_url('public/') ?>js/admin/pages/dashboard.js"></script>
